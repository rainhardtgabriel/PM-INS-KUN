 ...
 *	Name: defines.hpp
 *	Author:	DerZade
 *	Description: includes all Base Classes
 *	
 *	Parameter: NONE
 *	
 *	Return Value: NONE
...
class ZadeServicePoint_RscText
{
	access = 0;
	type = 0;
	idc = -1;
...
class ZadeServicePoint_RscListBox
{
	access = 0;
	type = 5;
	w = 0.4;
...
class ZadeServicePoint_RscButton
{
	access = 0;
	type = 1;
	text = "";
...
class ZadeServicePoint_RscFrame
{
	type = 0;
	idc = -1;
	style = 64;
...
class ZadeServicePoint_RscCheckBox
{
	idc = -1;
	type = 77;
	style = 0;
...
class ZadeServicePoint_RscPicture
{
	access = 0;
	type = 0;
	idc = -1;
